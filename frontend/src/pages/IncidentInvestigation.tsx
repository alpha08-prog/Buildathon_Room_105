...
import { attackGraphEdges, attackGraphNodes } from '@/data/mockData';
...
export default function IncidentInvestigation() {
  ...
  if (!incident) {
    return (
      <DashboardLayout>
        <GlassCard>
          <p className="text-sm text-muted-foreground">No incident has been generated by the backend yet.</p>
        </GlassCard>
      </DashboardLayout>
    );
  }
